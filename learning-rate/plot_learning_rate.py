...
ep_reward_list_2 = io.loadmat\
    ('D:/code-all/code_fl_1/upload/learning-rate/6ue-fl-adaptive-2/ep_reward_list.mat')
ep_reward_list_2 = ep_reward_list_2['array']
ep_reward_list_3 = io.loadmat\
    ('D:/code-all/code_fl_1/upload/learning-rate/6ue-fl-adaptive-3/ep_reward_list.mat')
ep_reward_list_3 = ep_reward_list_3['array']
ep_reward_list_4 = io.loadmat\
    ('D:/code-all/code_fl_1/upload/learning-rate/6ue-fl-adaptive-4/ep_reward_list.mat')
...
plt.plot(x2, reward_mean_2, label='$\eta=10^{-2}$', color='r')
plt.plot(x2, reward_mean_3, label='$\eta=10^{-3}$', color='b')
plt.plot(x2, reward_mean_4, label='$\eta=10^{-4}$', color='g')
plt.xlabel('Episodes')
plt.ylabel('Average reward')
plt.legend()
plt.tight_layout()
plt.show()
# plt.savefig('learning_rate.pdf', dpi=300)
