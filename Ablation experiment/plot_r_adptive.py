...
r_fl_mix = io.loadmat\
    ('D:/code-all/code_fl_1/upload/Ablation experiment/3ue-fl/ep_reward_list.mat')
r_fl_mix = r_fl_mix['array'][0]
...
plt.plot(x2, reward_mean_5, label=r"AFDDPG with $\chi=1$", color='m')
plt.xlabel('Episodes')
plt.ylabel('Reward')
plt.legend()
plt.tight_layout()
plt.show()
# plt.savefig('ablation-alu-1.pdf', dpi=300)