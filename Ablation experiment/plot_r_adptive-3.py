...
r_fl_mix = io.loadmat\
    ('D:/code-all/code_fl_1/upload/Ablation experiment/3ue-fl-adaptive-both-5-3/ep_reward_list.mat')
...
plt.plot(x2, reward_mean_5, label=r"AFDDPG with $\chi=0.3$", color='g')
plt.xlabel('Episodes')
plt.ylabel('Reward')
plt.legend()
plt.tight_layout()
plt.show()
# plt.savefig('ablation-alu-3.pdf', dpi=300)